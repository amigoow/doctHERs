...
<body>
	...
	<div class="wrapper">
		...
		<h2 style="color:#fff;">DoctHers</h2>
		</div>
...
<?php echo $errmsg; ?>
                    ...
                    <div class="panel-heading">
                        ...
                        <div style="float:right; font-size: 80%; position: relative; top:-10px"><a href="reset" style="color:#fff;">Forgot password?</a></div>
                    </div>
